...
print(' ')
max_produce = (produce['Total Sales'].idxmax(), produce['Total Sales'].max())
min_produce = (produce['Total Sales'].idxmin(), produce['Total Sales'].min())
print(max_produce)
print(min_produce)
...
print(' ')
apricot_qty = produce.at['Apricots', 'Quantity Sold'] = 11955
apricot_sales = produce.at['Apricots', 'Total Sales'] = 44353.05
print(produce)
...
print(' ')
avg_qty = produce['Quantity Sold'].mean()
print(avg_qty)
...
print(' ')
new_produce = produce[(produce['Quantity Sold'] <= 12000) & (
    produce['Quantity Sold'] >= 11500)]

print(new_produce['Quantity Sold'])
...
print(' ')
print(new_produce['Total Sales'].sum())
# I am unsure if you want sum of sales or sales for each produce so here are both
